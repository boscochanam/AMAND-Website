...
def blog_page(page_name):
    ...
    if blog_data:
        ...
        return render_template('blogpage.html', date = blog_data['date'] ,title=blog_data['title'], content=blog_data['content'], images=blog_data['images'], event_data=event_data)
    else:
